...
public interface SaveChatMessageService {
    SaveChatMessageResponse execute(Long messageId, Long roomId, String content, List<Long> imageIds, MessageType messageType, Long senderId, LocalDateTime createdAt);
}
